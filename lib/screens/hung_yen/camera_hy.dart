...
class CameraHyScreen extends StatefulWidget {
  const CameraHyScreen({super.key});

  @override
  State<CameraHyScreen> createState() => _CameraHyScreenState();
}

class _CameraHyScreenState extends State<CameraHyScreen> {
